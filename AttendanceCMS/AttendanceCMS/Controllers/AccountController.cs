...
namespace AttendanceCMS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(EmployeeVM model, string returnUrl)
        {
            ...
            Result = mainRepository.Login(model);

            switch (Result.status)
            {
                case "Success":
                    Session["LoginId"] = Result.LoginId.ToString();
                    Session["AppId"] = Result.AppId.ToString();
                    Session["UserProfile"] = Result;
                    AddSession(Result.UserID, "", Result.LoginId, Result.UserName);
        ...
        [NonAction]
        private void AddSession(int UserId, string UserRole, string UserEmail, string UserName)
        {
            try
            {
        ...
        public object Elmah { get; private set; }
