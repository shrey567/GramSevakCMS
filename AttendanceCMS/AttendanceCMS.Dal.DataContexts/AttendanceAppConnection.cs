...
{
    class AttendanceAppConnection
    {
        public static string GetConnectionString(int AppId)
        {
            try
            {
                const string DefaultStringCon = @"metadata=res://*/AppyAttendanceChild.csdl|res://*/AppyAttendanceChild.ssdl|res://*/AppyAttendanceChild.msl;provider=System.Data.SqlClient;provider connection string='";
                ...
                using (var context = new AppyAttendanceMainEntities())
                {
